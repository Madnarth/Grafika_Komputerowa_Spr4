...

{
	...
	error = load_targa("oak_tree_big_20131230_1305535818.tga", width, height, format, type, pixels);
...

	{
		...
		printf("Niepoprawny odczyt pliku oak_tree_big_20131230_1305535818.tga");
